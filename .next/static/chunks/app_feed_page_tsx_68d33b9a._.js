...
function AIAssistantPage() {
    ...
    const [, setChatHistory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const handleSendMessage = async ()=>{
        ...
        try {
            ...
            const errMessage = (_this = error) === null || _this === void 0 ? void 0 : _this.message;
            assistantContent = errMessage ? "Sorry, I encountered an error: ".concat(errMessage, ". Please try again.") : "Sorry, I couldn't fetch a response from our AI right now. Please try again in a moment.";
        }
...
_s(AIAssistantPage, "vPMOD9YkoDbGNVvCp5ZIsADWK/4=");
_c = AIAssistantPage;
var _c;
