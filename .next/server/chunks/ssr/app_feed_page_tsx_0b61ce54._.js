    ...
    const handleSendMessage = async ()=>{
        ...
        setTimeout(()=>{
            ...
            const aiResponse = {
                ...
                content: restaurants.length > 0 ? `Here are ${restaurants.length} ${inputMessage.trim().toLowerCase().includes('cozy') ? 'cozy coffee spot' : 'recommendations'} in Cebu City you should try:` : "Let me help you find great places!",
