...
function AIAssistantPage() {
    ...
    const handleSendMessage = async ()=>{
        ...
        try {
            ...
            assistantContent = errMessage ? `Sorry, I encountered an error: ${errMessage}. Please try again.` : "Sorry, I couldn't fetch a response from our AI right now. Please try again in a moment.";
        }
